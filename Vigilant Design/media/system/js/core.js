 ...
 */
if ("undefined" === typeof Vigilant)var Vigilant = {};
Vigilant.editors = {};
Vigilant.editors.instances = {};
Vigilant.submitform = function (a, b) {
...
Vigilant.submitbutton = function (a) {
    Vigilant.submitform(a)
};
Vigilant.JText = {strings: {}, _: function (a, b) {
...
Vigilant.renderMessages = function (i) {
    Vigilant.removeMessages();
    ...
    Object.each(i, function (d, e) {
        ...
        f.inject(j);
        var g = new Element('h4', {'class': 'alert-heading', html: Vigilant.JText._(e)});
        g.inject(f);
...
function checkAll_button(a, b) {
    ...
    for (var c = 0; c <= a; c++) {
        ...
        if (d)!1 == d.checked && (d.checked = !0); else {
